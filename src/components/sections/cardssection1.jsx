...
const images = [
  { id: 0, src: image1, link: "https://skygliders.netlify.app/" },
  { id: 1, src: image2, link: "https://askweb7.netlify.app/" },
  { id: 2, src: image3, link: "https://askweb03.netlify.app/" },
  { id: 3, src: image4, link: "https://askweb8.netlify.app/" },
  { id: 4, src: image5, link: "https://askweb02.netlify.app/" },
  { id: 5, src: image6, link: "https://ask01.netlify.app/" },
  { id: 6, src: image7, link: "https://askweb04.netlify.app/" },
];
    ...
    >
      ...
      >
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
          The Essence of <span className="text-[#00E3CC]">Creativity</span>
        </h2>
        <p className="text-[#B4C3CC] text-sm sm:text-base md:text-lg leading-relaxed">
          Every detail is crafted with intention, ensuring clarity and impact in
          every interaction.
        </p>
      </motion.div>
